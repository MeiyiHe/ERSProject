...
def covering_p(username, filename):
	#clock
	...
	combined.export("{}_poutput.wav".format(script_r[:-4]), format="wav")

	print("finished!")
	print("--- %s seconds ---" % (time.time() - start_time))

#covering_p('abk','covering_test_V1.txt')
