...
def genLib_m_phon(username, input_file):
	...
	TG = m+"/result/data/"+input_file+".TextGrid"                            #montreal-force-aligner/result/data/abk_1705010000.TextGrid
	lab = m+"/data/"+input_file+".lab"                                       #montreal-force-aligner/data/abk_1705010000.lab
	dic = m+"/dicts/"+input_file+"_m_dict"                                   #montreal-force-aligner/dicts/abk_1705010000_m_dict
	tag_script = username+"/"+input_file+"_m_phonTag.txt"                    #abk/abk_1705010000_m_phonTag.txt
	...
	phonTags(script, dic, tag_script, 'm', '0')
	print('\n')
	print("txt processed.")
...
def genLib_m_punc(username, input_file):
	...
	lab = m+"/data/"+input_file+".lab"                                       #montreal-force-aligner/data/abk_1705010000.lab
	dic = m+"/dicts/"+input_file+"_m_dict"                                   #montreal-force-aligner/dicts/abk_1705010000_m_dict
	tag_script = username+"/"+input_file+"_m_puncTag.txt"                    #abk/abk_1705010000_m_puncTag.txt
	script = username+"/"+input_file+".txt"                                  #abk/abk_1705010000.txt
	soundinpath = username+"/"+input_file+".wav"                             #abk/abk_1705010000.wav
	soundoutpath = username+"/GL_m_punc"                                     #abk/GL_m_punc

	#run the aligner
	runM(m, dic, lab, script, soundinpath)

	#Process the script file
	puncTags(script, tag_script, 'm', '0')
	print('\n')
	print("txt processed.")
	...
	#Cut the audio according to the timestamps and the script
	cut_punc(tag_script, timestamps, soundinpath, soundoutpath)
...
def genLib_p_punc(username, input_file):
	...
	tag_script = username+"/"+input_file+"_p_puncTag.txt"                    #abk/abk_1705010000_p_puncTag.txt
	script = username+"/"+input_file+".txt"                                  #abk/abk_1705010000.txt
	soundinpath = username+"/"+input_file+".wav"                             #abk/abk_1705010000.wav
	soundoutpath = username+"/GL_p_punc"                                     #abk/GL_p_punc

	#run the aligner
	runP(p, lab, script, soundinpath)	

	#Process the script file
	puncTags(script, tag_script, 'p', '0')
	print('\n')
	print("txt processed.")
...
def genLib_p_phon(username, input_file):
	...
	dic = m+"/dicts/"+input_file+"_p_dict"                                   #montreal-force-aligner/dicts/abk_1705010000_p_dict
	tag_script = username+"/"+input_file+"_p_phonTag.txt"                    #abk/abk_1705010000_p_phonTag.txt
	script = username+"/"+input_file+".txt"                                  #abk/abk_1705010000.txt
	soundinpath = username+"/"+input_file+".wav"                             #abk/abk_1705010000.wav
	soundoutpath = username+"/GL_p_phon"                                     #abk/GL_p_phon
	...
	#Process the script file
	phonTags(script, dic, tag_script, 'p', '0')
	print('\n')
	print("txt processed.")
