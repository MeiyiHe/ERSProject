...
def generateLibW(username, filename):
	...
	script = username+"/"+sys.argv[2]+".txt"                                  #abk/word_abk_1705010000.txt
	preprocessed_script = username+"/"+sys.argv[2]+"_preprocess.txt"          #abk/word_abk_1705010000_preprocess.txt
	timestamps_file = username+"/"+sys.argv[2]+"_TIMESTAMPS.txt"              #abk/word_abk_1705010000_TIMESTAMPS.txt
	soundinpath = username+"/"+sys.argv[2]+".wav"                             #abk/word_abk_1705010000.wav
