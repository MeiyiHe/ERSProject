...
def generateLib(username, filename):
	...
	script = username+"/"+filename+".txt"                                  #abk/abk_1705010000.txt
	preprocessed_script = username+"/"+filename+"_preprocess.txt"          #abk/abk_1705010000_preprocess.txt
	timestamps_file = username+"/"+filename+"_TIMESTAMPS.txt"              #abk/abk_1705010000_TIMESTAMPS.txt
	soundinpath = username+"/"+filename+".wav"                             #abk/abk_1705010000.wav
